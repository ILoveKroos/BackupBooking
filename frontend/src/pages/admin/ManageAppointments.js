  ...
  return (
    <div className="manage-appointments">
      <h1>
        {isStaffView
          ? isCashierView
            ? 'Lịch hẹn — quản lý phân công (Thu ngân)'
      ...
      <p className="appointment-page-note">
        {isStaffView
          ? isCashierView
            ? 'Bạn xem và xử lý toàn bộ lịch hẹn đã gán cho nhân viên dịch vụ: xác nhận nhận lịch, hủy lịch, đổi trạng thái, xử lý yêu cầu hủy của khách — tương tự quyền quản trị trên danh sách lịch.'
