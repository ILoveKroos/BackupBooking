          ...
          <div className="form-group">
            ...
            >
              ...
              {staffOptions.map((staff) => (
                ...
                >
                  {staff.name}
                  {!!appointmentDate && !!appointmentTime && !staff.isAvailable ? ' - Không khả dụng' : ''}
                </option>
              ))}
            </select>
            ...
            {!staffError && !!appointmentDate && !!appointmentTime && !loadingStaffAvailability && (
              <small className="field-hint">
                Có {availableStaffCount}/{allStaff.length} nhân viên khả dụng ở khung giờ này (đã tính lịch làm
                việc hằng tuần và lịch đã đặt).
              </small>
            )}
          </div>
